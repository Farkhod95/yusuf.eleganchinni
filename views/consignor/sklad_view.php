...
$this->title = 'Import tovarlar tarixi';
$i = 1;
$sumCount = 0;
$allMarkCount = 0
?>
                ...
                <table class="table">
                        ...
                        <tbody>
                            <?php  foreach ($warehouse as $model) { $i = 1; $allCount = 0;?>
                                ...
                                <?php  foreach ($warehouses = WarehouseHistory::find()->andWhere(['brand_id' => $model->brand->id])->andWhere(['sklad_id' => $sklads_is])->all() as $model1) { ?>
                                    <tr>
                                        <td><?= $i ?></td>
