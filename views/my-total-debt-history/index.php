...
$this->title = 'Mening to\'lagan qarzlarim hisobi';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);
$query = $dataProvider->query;
$totalDebtSum = $query->sum('total_debt');
?>
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <!-- <a href="/my-total-debt/create" role="modal-remote" class="btn btn-xs  btn-success">Qo'shish <i class="fa fa-plus"></i> </a> -->
        ...
        <h4 class="panel-title"><b style="font-size: 18px;"><?= $model->consignor->name ?></b> dan to'lagan qarzlarim hisobi</b></h4>
    </div>
