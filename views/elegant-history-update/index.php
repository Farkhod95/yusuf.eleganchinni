...
$this->title = 'Tizimdagi o\'zgarishlar hisobi';
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <!-- <a href="/elegant-history-update/create" role="modal-remote" class="btn btn-xs  btn-success">Qo'shish <i class="fa fa-plus"></i> </a> -->
