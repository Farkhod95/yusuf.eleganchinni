...
$this->title = 'Vozvrat buyurtmalar tarixi';
...
<div class="panel panel-inverse user-index">
    <div class="panel-heading" style="background-color: #b35555;">
        <div class="panel-heading-btn" >
            ...
            <!-- <a href="/brands/create" role="modal-remote" class="btn btn-xs  btn-success">Qo'shish <i class="fa fa-plus"></i> </a> -->
        ...
        <h4 class="panel-title">Vozvrat buyurtmalar tarixi</h4>
    </div>
